...
btnEdit.addEventListener("click", function () {
  ...
  document.querySelector(".imageDiv2").innerHTML = '<img class="image1 rounded-circle mb-2" id="myImg" src="images/addimg.png" alt="your image"><input type="file" class="inputImage"/>';
  $(function () {
  ...
  document.querySelector(".fullInfo").innerHTML = '<div class="pl-4"><form><input type="text" placeholder="Full Name" class="data widthInput mb-2 border-0 fullName"><textarea rows="1" type="text" placeholder="Professional title" class="data1 textarea1 widthInput border-0 professionalTitle job" id="dload-txt"></textarea><div class="aboutMe d-flex align-items-center"><i class="fas fa-times info iconDelete"></i><textarea rows="1" type="text" placeholder="About me" class="data1 textarea2 widthInput border-0 delete"></textarea></div</form></div>';
  ...
  // Practical Info 
  document.querySelector(".practicalInfo2").innerHTML = '<div class="width"><i class="fas fa-envelope text-white"></i><input type="email" placeholder="Email" class="data mb-1 border-0 widthInput inputPractical"></div><div class="width"><i class="fas fa-mobile-alt text-white"></i><input type="phone" placeholder="Phone Number" class="data mb-1 border-0 widthInput inputPractical"></div><div class="width"><i class="fas fa-map-marker text-white"></i> <input type="text" placeholder="City, Country" class="data mb-1 border-0 widthInput inputPractical"></div><div class="twitter w-50"><i class="fas fa-times info iconDelete1 text-white"></i><i class="fab fa-twitter text-white"></i><input type="text" placeholder="Twitter" class="data mb-1 border-0 inputPractical widthInput"></div><div class="linkedin w-50"><i class="fas fa-times info iconDelete2 text-white"></i><i class="fab fa-linkedin text-white"></i><input type="text" placeholder="Linkedin" class="data mb-1 border-0 inputPractical widthInput"> </div>';
  document.querySelector(".practicalInfo2").addEventListener("mouseover", function () {
  ...
  //Work experience
  document.querySelector(".anotherPosition").innerHTML = '<div><div class="pt-3"><p class="h5 text-uppercase ml-4 workColor">work experience</p><div class="workEx d-flex align-items-center"><div class="line"></div><i class="fas fa-times info iconDel mr-2"></i><i class="fas fa-plus-square info iconAdd"></i><input type="text" placeholder="Position/Title" class="data border-0 widthInput position ml-2"></div><input type="text" placeholder="Company/Workplace" class="data border-0 widthInput ml-4"></div><div class="d-flex justify-content-between"><div><input type="text" placeholder="00/0000 - 11/1111"  class="data border-0 widthInput italic ml-4"></div><div><input type="text" placeholder="City, Country"  class="data text-right border-0 widthInput italic"></div></div><div><input type="text" placeholder="Accomplishments/Tasks/Duties" class="data border-0 widthInput1 italic ml-4"></div><div class="ulList"><ul class="list2 ml-4"><div class="taskDel1"><i class="fas fa-times info iconDel1"></i><li><textarea rows="1" type="text" placeholder="Accomplishments" class="data1 textarea3 border-0 widthInput"></textarea></li></div><div class="taskDel2"><i class="fas fa-times info iconDel2"></i><li><textarea rows="1" type="text" placeholder="Task" class="data1 textarea4 border-0 widthInput"></textarea></li></div><div class="taskDel3"><i class="fas fa-times info iconDel3 mr-2"></i><i class="fas fa-plus-square info iconAdd1"></i><li class="addTask"><textarea rows="1" type="text" placeholder="Task" class="data1 textarea5 border-0 widthInput"></textarea></li></div></ul></div></div>';
  ...
  document.querySelector(".anotherPosition").addEventListener("click", function () {
    tipsParagraph.innerText = "List the ​job experiences​ that are relevant to the position you’re applying for. If you’re currently working,your current job titles. Leave your most recent experience first, and the oldest ones last. Enable the reader to see what he needs to about your experience right away. Describe every job title with a few words about your most relevant experiences connected to the title you’re applying for.";
  })
  ...
  document.querySelector(".iconAdd").addEventListener("click", function () {
    document.querySelector(".ulList").innerHTML += '<div class="newAdd"><div class="pt-3"><div class="workEx d-flex align-items-center pl-0"><div class="line"></div><i class="fas fa-times info iconDel mr-2"></i><input type="text" placeholder="Position/Title" class="data border-0 widthInput position ml-2"></div><input type="text" placeholder="Company/Workplace" class="data border-0 widthInput ml-4"></div><div class="d-flex justify-content-between"><div><input type="text" placeholder="00/0000 - 11/1111" class="data border-0 widthInput italic ml-4"><input type="text" placeholder="Accomplishments/Tasks/Duties" class="data border-0 widthInput1 italic ml-4"></div><div><input type="text" placeholder="City, Country" class="data text-right border-0 widthInput italic"></div></div><ul class="list2 ml-4"><div class="taskDel1"><li><input type="text" placeholder="Accomplishments" class="data border-0 widthInput"></li></div><div class="taskDel2"><li><input type="text" placeholder="Task" class="data border-0 widthInput"></li></div><div class="taskDel3"><li class="addTask"><input type="text" placeholder="Task" class="border-0 widthInput data"></li></div></ul></div>';
    let allDelPositions = document.querySelectorAll(".iconDel");

    document.querySelector(".ulList").addEventListener("mouseover", function () {
    ...
    document.querySelector(".ulList").addEventListener("mouseout", function () {
      allDelPositions.forEach(el => {
  ...
  document.querySelector(".iconAdd1").addEventListener("click", function () {
    document.querySelector(".addTask").innerHTML += '<div class="newAdd"><li class="addTask"><span>&ndash;</span><input type="text" placeholder="Task" class="data border-0 widthInput"></li></div>';
  ...
  //Education
  document.querySelector(".educationDiv").innerHTML = '<div><div class="pt-3"><p class="h5 text-uppercase ml-4 educationColor">education</p><div class="edu d-flex align-items-center"><div class="line"></div><i class="fas fa-times info delEducation mr-2"></i><i class="fas fa-plus-square info eduAdd"></i><input type="text" placeholder="Study program" class="data border-0 widthInput position ml-2"></div><input type="text" placeholder="Instutution" class="data border-0 widthInput ml-4"></div><div class="d-flex justify-content-between"><div><input type="text" placeholder="mm/year - mm/year"  class="data border-0 widthInput italic ml-4"></div><div><input type="text" placeholder="City, Country"  class="data text-right border-0 widthInput italic"></div></div><div><input type="text" placeholder="Studied/Courses" class="data border-0 widthInput1 italic ml-4"></div><div class="ulList1"><ul class="list2 ml-4"><div class="educationDel1"><i class="fas fa-times info eduDel1"></i><li><textarea rows="1" type="text" placeholder="Accomplishments" class="data1 textarea6 border-0 widthInput"></textarea></li></div><div class="educationDel2"><i class="fas fa-times info eduDel2"></i><li><textarea rows="1" type="text" placeholder="Task" class="data1 textarea7 border-0 widthInput"></textarea></li></div><div class="educationDel3"><i class="fas fa-times info eduDel3 mr-2"></i><i class="fas fa-plus-square info eduAdd1"></i><li class="eduTask"><textarea rows="1" type="text" placeholder="Task" class="data1 textarea8 border-0 widthInput"></textarea></li></div></ul></div></div>';
  ...
  document.querySelector(".educationDiv").addEventListener("click", function () {
    tipsParagraph.innerText = "Under education, list only the ​relevant studies and courses​, like university degree or Digital Marketing Academy. Don’t write where you went to high school.";
  })
  //Delete education
  ...
  document.querySelector(".eduAdd").addEventListener("click", function () {
    document.querySelector(".ulList1").innerHTML += '<div class="newAdd"><div class="pt-3"><div class="edu d-flex align-items-center"><div class="line"></div><i class="fas fa-times info delEducation mr-2"></i><input type="text" placeholder="Study program" class="data border-0 widthInput position ml-2"></div><input type="text" placeholder="Instutution" class="data border-0 widthInput ml-4"></div><div class="d-flex justify-content-between"><div><input type="text" placeholder="mm/year - mm/year" class="data border-0 widthInput italic ml-4"><input type="text" placeholder="Studied/Courses" class="data border-0 widthInput1 italic ml-4"></div><div><input type="text" placeholder="City, Country" class="data text-right border-0 widthInput italic"></div></div><ul class="list2 ml-4"><div class="educationDel1"><li><input type="text" placeholder="Accomplishments" class="data border-0 widthInput"></li></div><div class="educationDel2"><li><input type="text" placeholder="Task" class="data border-0 widthInput"></li></div><div class="educationDel3"><li class="eduTask"><input type="text" placeholder="Task" class="data border-0 widthInput"></li></div></ul></div>';
    let allDelEducation = document.querySelectorAll(".delEducation");
    document.querySelector(".ulList1").addEventListener("mouseover", function () {
    ...
    document.querySelector(".ulList1").addEventListener("mouseout", function () {
      allDelEducation.forEach(el => {
        el.classList.add("info");
      })
    })
  ...
  // Skills
  document.querySelector(".skillsLanguages").innerHTML = '<div class="skillsAndCompetencies"><i class="fas fa-times info delSkills mr-2"></i><p class="h5 text-uppercase skillsColor">skills</p></div><div class="skillsDiv skillsColor"><div class="d-flex"><div class="skillDiv1 pt-2"><i class="fas fa-times info delSkill1 mr-2"></i><span class="skillsText1 border-0" role="textbox" contenteditable>Skill 1</span></div><div class="skillDiv2 pt-2"><i class="fas fa-times info delSkill2 mr-2"></i><span class="skillsText1 border-0" role="textbox" contenteditable>Skill 2</span></div></div><div class="d-flex"><div class="skillDiv3 pt-2"><i class="fas fa-times info delSkill3 mr-2"></i><span class="skillsText1 border-0" role="textbox" contenteditable>Skill 3</span></div><div class="skillDiv4 pt-2"><i class="fas fa-times info delSkill4 mr-2"></i><i class="fas fa-plus-square info skillAdd"></i><span class="skillsText1 border-0" role="textbox" contenteditable>Skill 4</span></div></div></div>';
  ...
  document.querySelector(".skillsLanguages").addEventListener("mouseover", function () {
    document.querySelector(".delSkills").classList.remove("info");
  })
  document.querySelector(".skillsLanguages").addEventListener("mouseout", function () {
    document.querySelector(".delSkills").classList.add("info");
  })
  document.querySelector(".delSkills").addEventListener("click", function () {
    document.querySelector(".skillsLanguages").remove();
  })
  ...
  document.querySelector(".skillAdd").addEventListener("click", function () {
    document.querySelector(".skillDiv4").innerHTML += '<div class="skillDiv4New pt-2"><i class="fas fa-times delSkill5 info mr-2"></i><span class="skillsText1 border-0" role="textbox" contenteditable>Skill</span></div>';
    document.querySelector(".skillDiv4").addEventListener("mouseover", function () {
  ...
  document.querySelector(".achievementsDiv").innerHTML = '<div class="achievementDiv"><i class="fas fa-times info delAchievements mr-2"></i><p class="h5 text-uppercase pt-4 achievementsColor">achievements</p><div class="dates datesDiv1"><i class="fas fa-times info delAchievement1 mr-2"></i><textarea type="text" placeholder="Achievement" rows="1" class="data1 textarea9 border-0 widthInput"></textarea><textarea type="text" placeholder="If needed write here description about achievement" rows="1" class="data1 textarea10 border-0 w-100 achievements"></textarea></div><div class="dates pt-2 datesDiv2"><i class="fas fa-times info delAchievement2 mr-2"></i><i class="fas fa-plus-square info achievementAdd"></i><textarea type="text" placeholder="Achievements" rows="1" class="data1 textarea11 border-0 widthInput"></textarea><textarea type="text" placeholder="If needed write here description about achievement" rows="1" class="data1 textarea12 border-0 w-100 achievements"></textarea></div></div>';
  ...
  document.querySelector(".achievementsDiv").addEventListener("click", function () {
    tipsParagraph.innerText = "Highlight the key achievements you have presented on your CV so the hiring manager can catch them very quickly.";
  })

  //Delete achievement

  document.querySelector(".achievementsDiv").addEventListener("mouseover", function () {
    document.querySelector(".delAchievements").classList.remove("info");
  })
  document.querySelector(".achievementsDiv").addEventListener("mouseout", function () {
  ...
  document.querySelector(".delAchievements").addEventListener("click", function () {
    document.querySelector(".achievementsDiv").remove();
  })
  ...
  document.querySelector(".achievementAdd").addEventListener("click", function () {
    document.querySelector(".datesDiv2").innerHTML += '<div class="pt-2 datesDivNew"><i class="fas fa-times delAchievement3 info mr-2"></i><input type="text" placeholder="Achievements" class="data border-0 widthInput"><div><input type="text" placeholder="If needed write here description about achievement" class="data border-0 w-100 achievements"></div></div>';
    document.querySelector(".datesDiv2").addEventListener("mouseover", function () {
  ...
  document.querySelector(".languages").innerHTML = '<div class="languagesDiv"><i class="fas fa-times info delLanguages mr-2"></i><p class="h5 text-uppercase pt-4 languagesColor">LANGUAGES</p><div class="dates english"><i class="fas fa-times info delEnglish mr-2"></i><textarea type="text" placeholder="English" rows="1" class="data1 textarea13 border-0 widthInput"></textarea><textarea type="text" placeholder="Full Professional Proficiency" rows="1" class="data1 textarea14 border-0 w-100 achievements"></textarea></div><div class="dates language1 pt-2"><i class="fas fa-times info delLanguage1 mr-2"></i><i class="fas fa-plus-square info languageAdd"></i><textarea type="text" placeholder="Language" rows="1" class="data1 textarea15 border-0 widthInput"></textarea><textarea type="text" placeholder="Limited Working Proficiency" rows="1" class="data1 textarea16 border-0 w-100 achievements"></textarea></div></div>';
  ...
  document.querySelector(".languageAdd").addEventListener("click", function () {
    document.querySelector(".language1").innerHTML += '<div class="pt-2 languageNew"><i class="fas fa-times delLanguage2 info mr-2"></i><input type="text" placeholder="Language" class="data border-0 widthInput"><div><input type="text" placeholder="Limited Working Proficiency" class="data border-0 w-100 achievements"></div></div>';
    document.querySelector(".language1").addEventListener("mouseover", function () {
...
document.querySelector(".tips1").addEventListener("mouseover", function () {
  tipsParagraph1.innerText = "Make sure that your title matches your skills. E.g., if you’re an entry level PPC specialist, don’t say that you’re a PPC Expert. Skip the abbreviations and titles – keep it short and modest. Be concise and easy to understand. Don’t use overdone motivational quotes about work ethics and inspiration. Use the new “Open for business” feature. State your area of expertise and industry, to let recruiters know they can reach you. Don’t write in things that you wouldn’t like to happen.";
})
